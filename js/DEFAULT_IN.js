...
function update_check(sq_version){
	...
	// 		}else{
	// 		var msg="<div class='alert alert-danger'>New version available: Savsoft Quiz v"+data.trim()+". You are using outdated version of Savsoft Quiz v"+sq_version+". Visit <a href='http://.com'>www.savsoftquiz.com</a> to download</div>";	
